...
async function GET() {
    try {
        const cart = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cart$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCart"])();
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Failed to get cart", "CART_ERROR", 500);
    }
}
async function POST(request) {
    try {
        ...
        // Validate input
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cartItemSchema"].safeParse(body);
        if (!validationResult.success) {
            const errors = validationResult.error.issues.map((issue)=>issue.message).join(', ');
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(errors, "VALIDATION_ERROR", 400);
        }
        const { productId, quantity } = validationResult.data;
        const cart = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cart$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addToCart"])(productId, quantity);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(cart, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a413cb24._.js.map