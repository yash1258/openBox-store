...
"[project]/src/app/api/auth/dev-login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        ;
        // Check for dev secret (optional extra security)
        const body = await request.json();
        const { devSecret } = body;
        // Optional: Add a simple secret check for extra safety
        const expectedSecret = process.env.DEV_LOGIN_SECRET || 'dev-mode-123';
        if (devSecret !== expectedSecret) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid dev credentials", "UNAUTHORIZED", 401);
        }
        // Get the first seller or create a test seller
        const { prisma } = await __turbopack_context__.A("[project]/src/lib/prisma.ts [app-route] (ecmascript, async loader)");
        let seller = await prisma.seller.findFirst();
        if (!seller) {
            // Create a test seller if none exists
            const { hashPassword } = await __turbopack_context__.A("[project]/src/lib/auth.ts [app-route] (ecmascript, async loader)");
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Dev login failed", "LOGIN_ERROR", 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__3a7af221._.js.map